    ...
    <header className="sticky top-0 z-40 bg-slate-950/95 backdrop-blur-md border-b border-emerald-900/40 shadow-lg shadow-black/20">
      <div className="max-w-7xl mx-auto px-2.5 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-18 gap-1.5 sm:gap-4">
          ...
          {/* Logo Brand */}
          <div className="flex items-center gap-2 sm:gap-3 cursor-pointer shrink-0" onClick={() => setActiveTab('jobs')}>
            <div className="relative flex items-center justify-center w-9 h-9 sm:w-11 sm:h-11 rounded-xl overflow-hidden bg-slate-900 border border-emerald-500/40 shadow-lg shadow-emerald-500/10 shrink-0">
              <img 
              ...
              <span className="absolute -top-1 -right-1 flex h-2 w-2 sm:h-2.5 sm:w-2.5">
                ...
                <span className="relative inline-flex rounded-full h-2 w-2 sm:h-2.5 sm:w-2.5 bg-emerald-500 border border-slate-950"></span>
              </span>
            </div>
            
            <div className="flex flex-col">
              <div className="flex items-center gap-1">
                <span className="text-lg sm:text-2xl font-black tracking-tight text-white">Freela<span className="text-emerald-400">Hub</span></span>
                <span className="text-[9px] sm:text-[10px] uppercase font-bold tracking-widest px-1 sm:px-1.5 py-0.5 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/30">
                  OFICIAL
                </span>
              </div>
              <span className="text-[10px] sm:text-[11px] font-medium text-slate-400 tracking-wider hidden md:block">
          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            ...
            <button
              ...
              className={`flex items-center gap-1 sm:gap-1.5 px-2 py-1.5 sm:px-3 sm:py-2 rounded-xl text-xs font-black border transition ${
                isMissionsDone 
            ...
            <button
              ...
              className={`flex items-center gap-1 sm:gap-1.5 p-1.5 sm:px-3 sm:py-2 rounded-xl text-xs font-bold border transition ${
                isProfileConfigured
            ...
            <button
              ...
              className="flex items-center gap-1 p-1.5 sm:px-3 sm:py-2 rounded-lg text-xs font-semibold text-slate-300 bg-slate-900 hover:bg-slate-800 hover:text-white border border-slate-700/70 transition shrink-0"
              title="Configuração de Banco de Dados Neon / PostgreSQL / Vercel"
            >
              <Database className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-emerald-400 shrink-0" />
              <span className="hidden lg:inline">Neon / SQL</span>
            </button>

            <button
              id="btn-create-job"
              onClick={onOpenCreateJob}
              className="flex items-center gap-1.5 px-2.5 py-1.5 sm:px-4 sm:py-2 rounded-xl text-xs sm:text-sm font-black text-slate-950 bg-gradient-to-r from-emerald-400 to-green-500 hover:from-emerald-300 hover:to-green-400 shadow-md shadow-emerald-500/20 transition transform active:scale-95 shrink-0"
            >
              <PlusCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-slate-950 shrink-0" />
        ...
        {/* Navigation Tabs */}
        <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto no-scrollbar py-2 border-t border-slate-900 touch-pan-x">
          <button
            id="tab-jobs"
